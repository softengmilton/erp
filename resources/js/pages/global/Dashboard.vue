...
// First row widgets (scrollable, icon + name) - Original static widgets
...
// Second row widgets (stats) - Dynamic from backend
const secondRowWidgets = computed(() => [
  {
    title: 'Today Sales',
    value: formatCurrency(props.widgets.sales?.today || 0),
    gradientFrom: 'from-blue-500',
    gradientTo: 'to-indigo-400'
  },
  {
    title: 'Monthly Revenue',
    value: formatCurrency(props.widgets.revenue?.month || 0),
    gradientFrom: 'from-pink-500',
    gradientTo: 'to-red-400'
  },
  {
    title: 'Products',
    value: props.widgets.products?.toString() || '0',
    gradientFrom: 'from-yellow-400',
    gradientTo: 'to-orange-400'
  },
  {
    title: 'Total Due',
    value: formatCurrency(props.widgets.due || 0),
...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="p-4 flex flex-col gap-6">
      <!-- First row: Original static widgets -->
      ...
      <!-- Second row: Dynamic stats widgets -->
